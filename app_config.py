...
REPOSITORY_NAME = 'elections16-general'
...
ASSETS_SLUG = 'elections16-general'
...
ELEX_DISTRICTS_FLAGS = '-t --results-level district --raceids 0'
ELEX_INIT_FLAGS = '-t --national-only --results-level ru'

LOAD_RESULTS_INTERVAL = 10
DATA_OUTPUT_FOLDER = '.rendered'

SELECTED_HOUSE_RACES = [15038, 47019, 10031, 10019, 10041, 11586, 15999, 20645, 30015, 31211, 39015, 3004, 6618, 17009, 23805, 23811, 24028, 24010, 24013, 28385, 36581, 36604, 36599, 36602, 45893, 50068, 17073, 17071, 30155, 30992, 49548, 5715, 8514, 5741, 5697, 39023, 5711]
